    ...
    <Card>
      <CardBody>
        ...
        <Collapse isOpen={isOpen}>
          <UnitSelect pagefilter={carsfilter} ogdas={ogdas} hativas={hativas} gdods={gdods} handleChange2={handleChange2} level={"pikod"} />
        ...
        <SortingTable
          gdodsid={carsfilter.gdods} hativasid={carsfilter.hativas} ogdasid={carsfilter.ogdas} pikodsid={[match.params.pikodid]}
...
export default withRouter(PikodCarsTable);;