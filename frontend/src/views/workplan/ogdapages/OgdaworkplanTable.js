    ...
    <Card>
      <CardBody>
        ...
        <Collapse isOpen={isOpen}>
          <UnitSelect pagefilter={tipulsfilters} hativas={hativas} gdods={gdods} handleChange2={handleChange2} level={"ogda"} />
        ...
        <SortingTable
          gdodsid={tipulsfilters.gdods} hativasid={tipulsfilters.hativas} ogdasid={[match.params.ogdaid]}
...
export default withRouter(OgdaworkplanTable);;