...
import { Table, Button, Popconfirm, Row, Col, Image, Upload } from "antd";
import { ExcelRenderer } from "react-excel-renderer";
import {
	EditableFormRow,
	EditableCell,
} from "../../../../utils/workplan/EditTable";
...
export default class ExcelPageNexttreat extends Component {
	...
	handleSubmit = async () => {
		...
		data.map((row) => {
			...
			const type_of_treatment_performed_des =
				row.type_of_treatment_performed_des;
			const ugda = row.ugda;
			...
			axios
				.post("http://localhost:8000/api/nexttreat", {
					Designation,
					Designation_des,
					birthdate,
					call_number,
					...
					policy_des,
					policy_treatment,
					policy_treatment_des,
					type_of_treatment_performed,
					type_of_treatment_performed_des,
					ugda,
					ugda_des,
					unit,
					unit_des,
				...
				<div>
					...
					>
						<Button style={{ float: "right", marginBottom: "15px" }}>
							<Image type="upload" /> לחץ להעלת טבלת אקסל
						</Button>
					</Upload>
				</div>
