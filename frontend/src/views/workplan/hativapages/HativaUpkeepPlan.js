...
function HativaUpkeepPlan({ match }) {
    ...
    <>
      <Card>
        <CardBody>
          ...
          <UnitSelect pagefilter={magadalcarddata} gdods={gdods} handleChange2={handleChange2} level={"hativa"}/>
            ...
            {magadals.map((magadal, i) => (
              magadal ?
                <>
                  <Col xs={12} md={3}>
                    <MeagedalCard 
                    gdodsid={magadalcarddata.gdods} hativasid={[match.params.hativaid]} 
...
export default withRouter(HativaUpkeepPlan);;