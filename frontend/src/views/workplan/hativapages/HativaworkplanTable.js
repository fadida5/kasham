...
const HativaworkplanTable = ({ match }) => {
    ...
    <Card>
      <CardBody>
        ...
        <Collapse isOpen={isOpen}>
          <UnitSelect pagefilter={tipulsfilters} gdods={gdods} handleChange2={handleChange2} level={"hativa"} />
        ...
        <SortingTable
          gdodsid={tipulsfilters.gdods} hativasid={[match.params.hativaid]}
...
export default withRouter(HativaworkplanTable);;