      ...
      <Col xs={12} md={6}>
        ...
        <FormGroup dir="rtl" >
          ...
          {simpleValidator.current.message('expertsmax', tipuldata.tekenmax, 'required')}
                ...
                <div style={{ textAlign: 'right', paddingTop: '10px', fontWeight: "bold" }}>אמצעי ניוד אחזקה</div>
                ...
                <div style={{ textAlign: 'right', paddingTop: '10px', fontWeight: "bold" }}>אמצעי בק״ש </div>
                <Row>
                  <Col xs={12} md={6}>
                    <div style={{ textAlign: 'right', paddingTop: '10px' }}>תקן</div>
                    <FormGroup dir="rtl" >
