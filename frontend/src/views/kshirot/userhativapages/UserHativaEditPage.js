...
import MashaHativaPage from "./MashaHativaPage";
const UserHativaEditPage = ({ match }) => {
  ...
  const HativaNameHeader = (
    ...
    >
      <h1 style={{ color: "white", textAlign: "center" }}> כשירות מסגרות הטנ"א - {hativa.name}</h1>
    </Container>
  );
  ...
  return (
    <>
        ...
        {hativa.type === 'משא' ?  <MashaHativaPage/> :  (
          <>
            <Button>
...
export default withRouter(UserHativaEditPage);
