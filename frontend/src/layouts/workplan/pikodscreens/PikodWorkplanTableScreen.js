...
import PikodworkplanTable from "views/workplan/pikodpages/PikodworkplanTable";

function PikodWorkplanTableScreen(props) {
...
export default PikodWorkplanTableScreen;
