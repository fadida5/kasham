...
import UserAdminEditPage from "views/kshirot/useradminpages/UserAdminEditPage";


function UserAdminEditPageScreen(props) {
...
export default UserAdminEditPageScreen;