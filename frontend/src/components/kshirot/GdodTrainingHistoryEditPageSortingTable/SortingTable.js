                  ...
                  <tr {...row.getRowProps()}>
                    ...
                    {row.id != '0' ?
                      <td role="cell" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <Link to={`/edittrainingonly/${row.original._id}/${gdod._id}`}><button className="btn" style={{padding:'0.5rem',background:'#aac6d4'}}><img src={editpic} alt="bookmark" style={{height:'2rem'}}/></button></Link>
                        <Link><button className="btn" style={{padding:'0.5rem',background:'#ffb699'}} onClick={() => TrainingDelete(row.original._id)} ><img src={deletepic} alt="bookmark" style={{height:'2rem'}}/></button></Link>
                      </td>
                      :
                      <td role="cell" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}> <Link to={`/edittrainingonly/${row.original._id}/${gdod._id}`}><button className="btn" style={{padding:'0.5rem',background:'#ffb699'}}><img src={editpic} alt="bookmark" style={{height:'2rem'}}/></button></Link> </div>{/*row.original._id=user._id*/}
                      </td>
                    }
                  </tr>
                )
