  ...
  return (
    <>
      ...
      <Nav style={{ textAlign: 'right' }}>
        {/* <li>
          <NavLink to={`/ogdadashboard/${user.ogdaid}`} style={{margin:'0px'}} activeClassName="sidebar_active_link">
            <Row style={{ direction: 'rtl' }}>
              <Col xs={12} md={3} style={{ paddingLeft: '0px' }}>
                <img src={home} style={{ height: '20px' }}></img>
              </Col>
              <Col xs={12} md={9} style={{ paddingRight: '0px' }}>
                <h4 style={{color:color }}>דף הבית</h4>
              </Col>
            </Row>
          </NavLink>
        </li> */}
        {user.workplan === "0" || "1" ? (
          <li>
            {/* <Navbar style={{ display: "block", cursor: 'pointer', margin: "0px", paddingRight: "8px" }} onClick={toggleNavbar1}>
              <Row style={{ direction: 'rtl' }}>
                <Col xs={12} md={3} style={{ paddingLeft: '0px' }}>
                  <img src={table} style={{ height: '20px' }}></img>
                </Col>
                <Col xs={12} md={9} style={{ paddingRight: '0px' , margin:'0px'}}>
                  <h4 style={{color:color }}>תוכניות עבודה</h4>
                </Col>
              </Row>
              <Collapse isOpen={!collapsed1} navbar>
                <NavLink to={`/workplantableogda/${user.ogdaid}`} className="nav-link" style={{margin:'0px'}}activeClassName="sidebar_active_link">
                  <h4 style={{color:color }}>טבלה מסכמת</h4>
                </NavLink>
                <NavLink to="/addtipul" className="nav-link" style={{margin:'0px'}}>
                  <h4 style={{color:color }}>הוסף טיפול</h4>
                </NavLink>

                <NavLink to={`/ogdaupkeep/${user.ogdaid}`} className="nav-link" style={{margin:'0px'}}activeClassName="sidebar_active_link">>
                ...
                <NavLink to={`/ogdacarstable/${user.ogdaid}`} className="nav-link" style={{margin:'0px'}}activeClassName="sidebar_active_link">>
                  <h4 style={{color:color }}>'טבלת צ</h4>
                </NavLink>
                <NavLink to={`/ogdahistorytipuls/${user.ogdaid}`} className="nav-link" style={{margin:'0px'}}activeClassName="sidebar_active_link">>
        ...
        {user.kshirot === "0" || "1"?  (
          <li>
            <NavLink to={`/userogdaeditpage/${user.ogdaid}`} style={{margin:'0px'}}activeClassName="sidebar_active_link">
              <Row style={{ direction: "rtl" }}>
                <Col xs={12} md={3} style={{ paddingLeft: "0px" }}>
