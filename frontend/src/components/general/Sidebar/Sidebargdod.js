    ...
    <>
     <ThemeContext.Consumer>
      ...
      <Nav style={{ textAlign: "right" }}>
        {/* <li>
          <NavLink to={`/gdoddashboard/${user.gdodid}`} style={{margin:'0px'}}  activeClassName="sidebar_active_link">
          ...
          <li>
            ...
            >
              ...
              <Collapse isOpen={!collapsed1} navbar>
                <NavLink
                  to={`/workplantablegdod/${user.gdodid}`}
                  className="nav-link"
                  style={{margin:'0px'}}
              ...
              <h4 style={{ fontWeight: "bold" }}>סיכום לפי יחידות</h4>
                ...
                <NavLink
                  to={`/gdodhistorytipuls/${user.gdodid}`}
                  className="nav-link"
                  style={{margin:'0px'}}
                  activeClassName="sidebar_active_link">
        ...
        {user.kshirot === "0" || "1" ? (
        <li>
        <NavLink  to={`/usergdodeditpage/${user.gdodid}`} style={{margin:'0px'}}  activeClassName="sidebar_active_link">
          <Row style={{ direction: "rtl" }}>
            <Col xs={12} md={3} style={{ paddingLeft: "0px" }}>
