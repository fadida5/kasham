...
const { create, find, update, remove, findById,findhativabyid,updateogda,updategdods,updatematag,updatemataghistory,updateallmataghistoryarray,hativasbyogdaid} = require('../../controllers/general/hativa');
