...
import HativaHistoryTipuls from "views/workplan/hativapages/HativaHistoryTipuls";

function HativaHistoryTipulsScreen(props) {
...
export default HativaHistoryTipulsScreen;
