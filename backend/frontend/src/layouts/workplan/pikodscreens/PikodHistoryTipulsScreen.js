...
import PikodHistoryTipuls from "views/workplan/pikodpages/PikodHistoryTipuls";

function PikodHistoryTipulsScreen(props) {
...
export default PikodHistoryTipulsScreen;
