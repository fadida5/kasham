...
import UserHativaEditPage from "views/kshirot/userhativapages/UserHativaEditPage";

function UserHativaEditPageScreen(props) {
...
export default UserHativaEditPageScreen;