              ...
              page.map(row => {
                ...
                return (
                  <tr {...row.getRowProps()}>
                    ...
                    <td role="cell"> <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}> <Link to={`/edituser/${row.original._id}`}><button className="btn btn-success">עדכן</button></Link> </div> </td>{/*row.original._id=user._id*/}
