...
const EditTrainingOnlyForm = ({ match }) => {
    //react validator
  ...
  //var date = trainingdata.trainingamount.slice(0, 10);// a var cuz date input is a fcking mess.. but now it works
  ...
  function UpdateTraining() {
    ...
    axios.post(`http://localhost:8000/api/training/update`, [trainingidtemp, temptraining])
      .then(res => {
...
export default withRouter(EditTrainingOnlyForm);;