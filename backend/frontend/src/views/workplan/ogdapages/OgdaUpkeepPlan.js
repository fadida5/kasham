    ...
    <>
      <Card>
        <CardBody>
          ...
          <UnitSelect pagefilter={magadalcarddata} hativas={hativas} gdods={gdods} handleChange2={handleChange2} level={"ogda"}/>
            ...
            {magadals.map((magadal, i) => (
              magadal ?
                <>
                  <Col xs={12} md={3}>
                    <MeagedalCard 
                    gdodsid={magadalcarddata.gdods} hativasid={magadalcarddata.hativas} ogdasid={[match.params.ogdaid]}
...
export default withRouter(OgdaUpkeepPlan);;