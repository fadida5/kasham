...
const PikodworkplanTable = ({ match }) => {
  ...
  return (
    <Card>
      <CardBody>
        ...
        <UnitSelect pagefilter={tipulsfilters} pikods={[]} ogdas={ogdas} hativas={hativas} gdods={gdods} handleChange2={handleChange2} level={"pikod"}/>
        ...
        <SortingTable
          gdodsid={tipulsfilters.gdods} hativasid={tipulsfilters.hativas} ogdasid={tipulsfilters.ogdas} pikodsid={[match.params.pikodid]} 
...
export default withRouter(PikodworkplanTable);;